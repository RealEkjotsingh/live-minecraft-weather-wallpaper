...
function getClock(typeList, requestedType) {
  ...
  // fallback → always return first (usually clear)
  return typeList[0];
}

const night_cloudy = midnight_cloudy;
const night_rain = midnight_rain;
const night_snow = midnight_snow;

const noon_cloudy = day_cloudy;
const noon_rain = day_rain;
const noon_snow = day_snow;
